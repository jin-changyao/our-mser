...
dataset_name = os.environ.get('PRC_EMO_DATASET', 'iemocap')
data_folder = os.environ.get('PRC_EMO_DATA_FOLDER', './data/')
...
model_name = os.environ.get('PRC_EMO_MODEL_PATH', '/home/pc/jcy/models/Qwen2.5-7B-Instruct')
