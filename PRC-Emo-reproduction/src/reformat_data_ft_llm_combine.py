...
embedding_model_path = os.environ.get('PRC_EMO_EMBEDDING_MODEL_PATH', './models/all-MiniLM-L6-v2')
sentence_model = SentenceTransformer(embedding_model_path, device='cuda')
# === 新增：检索相似样本函数 ===
