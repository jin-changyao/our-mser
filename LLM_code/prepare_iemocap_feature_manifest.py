...
def build_manifest(feature_root, label_path, transcription_path, feature_dirs, split_csv=None):
...
def main():
    ...
    rows, report = build_manifest(feature_root, label_path, transcription_path, feature_dirs, split_csv)
